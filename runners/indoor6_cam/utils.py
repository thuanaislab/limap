...
def read_scene_indoor6(cfg, root_path, n_neighbors=20):
...
def get_scene_info(vsfm_path, imagecols):
    ...
    with open(test_val_list, 'r') as f:
        test_val_list = f.read().rstrip().split('\n')
...
def run_hloc_indoor6(cfg, image_dir, imagecols, neighbors, train_ids, query_ids, id_to_origin_name,

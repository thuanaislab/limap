...
from utils import read_scene_visualsfm, get_scene_info, get_result_filenames, eval, undistort_and_resize, run_hloc_12scenes, read_scene_12scenes
...
def parse_config(scene, vsfm_path):
    ...
    if cfg['output_dir'] is None:
        cfg['output_dir'] = 'tmp/12scenes/{}'.format(scene_id)
...
def main(scene, vsfm_path):
    ...
    imagecols, neighbors, ranges = read_scene_12scenes(cfg, cfg['vsfm_path'], n_neighbors=args.num_covis)
    ...
    ##########################################################
    ref_sfm, poses, hloc_log_file = run_hloc_12scenes(

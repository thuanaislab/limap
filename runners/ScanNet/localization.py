...
from utils import DepthReader, read_scene_ScanNet, get_result_filenames, run_hloc_ScanNet
from utils import image_path_to_rendered_depth_path, evaluate, create_reference_sfm_from_ScanNetDatset
...
def main(dataset_dir, scene, output_dir, use_dense_depth):
    ...
    ##########################################################
    poses, hloc_log_file, ids = run_hloc_ScanNet(
...
if __name__ == '__main__':
    ...
    main(dataset_dir, "scene0000_00", output_dir, use_dense_depth)

...
from utils import DepthReader, read_scene_indoor6, get_result_filenames, run_hloc_indoor6
...
def main():
    ...
    if cfg['output_dir'] is None:
        cfg['output_dir'] = 'tmp/indoor6/{}'.format(args.scene)
    ...
    depth_dir = args.dataset / f'depth/indoor6_{args.scene}/train/depth'
    retrieval_path = args.dataset / f'{args.scene}_netvlad_top10.txt'
    ...
    ##########################################################
    thuan_time_measure_start = time.time()
    ...
    thuan_time_measure_stop = time.time()
    print("Estimated time is: {} minutes".format((thuan_time_measure_stop-thuan_time_measure_start)/60))
